...
verJugadores.Name = "Rebs y Stats"
...
local function PGPDYH_fake_script() -- Frame_2.Script 
	...
	local verdad = false
	local usuarios = {
		{nombre= "kevinsanne0430",verificado = true},
	    	{nombre= "xxXDarknessRisingXxx",verificado = true},
				{nombre= "fernanfloP091o",verificado = true},
	}
	local contador = 0
	...
	if contador >=20 then
		while true do
			tetxo.Text = "Kevin no te ah puesto en el scrip!"
			wait(3)
	...
	local function autoquest(boolean)
		...
		for indice, v in ipairs(game:GetService("Workspace").Living:GetChildren()) do
			...
			revisarStats()-- revisa si tienes stats
				...
				elseif minimo >=4000000 and minimo < 6000000 then
				...
				elseif minimo >=6000000 and minimo < 50000000 then
			...
			elseif minimo >=600000000 and minimo < 900000000 then
				...
				elseif minimo >=900000000 and minimo < 1600000000 then
